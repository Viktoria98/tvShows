  ...
  render () {
    ...
    const items = this.props.options.map((item, index) => {
      ...
      return (
        <li
          key={index}
          className={classNames('dropdown__item', 'legend__button', item.color, {
            active: _.includes(this.props.selectedMetric, item.name),
          })}
      ...
      <div className="dropdown" onClick={this.toggleDropDown}>
        ...
        >
          <div
            ...
            style={{
              maxHeight: this.props.maxHeight || window.innerHeight - 250,
            }}
          >
            {items}
          </div>
