...
const SimpleDatepicker = class extends Component {
  ...
  componentWillReceiveProps (nextProps) {
    if (
      nextProps.preselected.year !== this.state.chosenYear ||
    ...
    if (!this.props.noMonths) {
      ...
      months = (
        <SelectDropdown
          ...
          className={classNames('dropdown__month', {
            '-error': this.props.error,
          })}
          label={properMonth || 'Month'}
          selected={this.state.chosenMonth}
        />
      );
    }
    if (!this.props.noYears) {
      years = (
        <SelectDropdown
          ...
          className={classNames('dropdown__year', {
            '-error': this.props.error,
          })}
          label={this.state.chosenYear || 'Year'}
    ...
    if (!this.props.noDays) {
      days = (
        <SelectDropdown
          ...
          className={classNames('dropdown__day', {
            '-error': this.props.error,
          })}
          label={this.state.chosenDay || 'Day'}
